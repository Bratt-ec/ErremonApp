...
const JuegoImagenes = () => {
  ...
  const Imagenes = ({ Tipo }) => {
    if (Tipo == "DRAGON") {
      setOracion('El dragón sale a volar por las montañas buscando su alimento');
      return (
    ...
    if (Tipo == "PLATO") {
      setOracion('El sol sale en la mañana y los niños salen a jugar despues de almorzar');
      return (
        <View style={css_JuegoImagenes.divJuego}>
          <View style={css_JuegoImagenes.divImgOracion}>
            <Image
    ...
    if (Tipo == "CANDADO") {
      setOracion('Maria luego de salir de clase abre el candado de la puerta para ingresar a su casa')
      return (
        <View style={css_JuegoImagenes.divJuego}>
          <View style={css_JuegoImagenes.divImgOracion}>
            <Image
    ...
    if (Tipo == "FOSFORO") {
      setOracion('Para endender la cocina usamos un fósforo y así podremos cocinar')
      return (
        <View style={css_JuegoImagenes.divJuego}>
          <View style={css_JuegoImagenes.divImgOracion}>
            <Image
    ...
    if (Tipo == "LIBRO") {
      setOracion('Lucas al salir de clase hace todas sus tareas y luego se va jugar al parque')
      return (
        <View style={css_JuegoImagenes.divJuego}>
          <View style={css_JuegoImagenes.divImgOracion}>
            <Image
    ...
    if (Tipo == "TAPILLA") {
      setOracion('La tapa es muy bonita sus curvas son como las flores y las nubes del cielo')
      return (
        <View style={css_JuegoImagenes.divJuego}>
          <View style={css_JuegoImagenes.divImgOracion}>
            <Image
    ...
    if (Tipo == "REGALO") {
      setOracion('La niña está muy feliz porque le regalaron un bonito vestido')
      return (
        <View style={css_JuegoImagenes.divJuego}>
          <View style={css_JuegoImagenes.divImgOracion}>
            <Image
  ...
  return (
    <View style={css_JuegoImagenes.Container}>
      ...
      {item == null && preGame == false && win !== true && lose !== true ? <RuletaView /> : null}
      {win ? <WinGame Siguiente='Menu' Win={true} NombreTrofeo='Master de las Oraciones' /> : null }
